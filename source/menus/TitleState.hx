...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.loadFrames('menus/title/logoBumpin');
		...
		gfDance.loadFrames('menus/title/gfDanceTitle');
		...
		titleText.loadFrames('menus/title/titleEnter');
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('menus/title/ng'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			FlxG.sound.play(Paths.sound('menus/sfx/confirm'), 0.7);
		...
		if (FlxG.keys.justPressed.SEVEN)
			FlxG.switchState(new debug.FrameBenchmark());
		#end
